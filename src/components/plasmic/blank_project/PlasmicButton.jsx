...
import sty from "./PlasmicButton.module.css"; // plasmic-import: jGNQ9KCLA4-/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: -UtrY0faITy/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: c0VfpELCV6T/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__vutg4)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__e5Pt)}
                role={"img"}
              />
            ),
