...
import sty from "./PlasmicButton.module.css"; // plasmic-import: MB4uDn9qI2c/css
import ChecksvgIcon from "../blank_project/icons/PlasmicIcon__Checksvg"; // plasmic-import: -UtrY0faITy/icon
import IconIcon from "../blank_project/icons/PlasmicIcon__Icon"; // plasmic-import: c0VfpELCV6T/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__lznKg)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__gduHi)}
                role={"img"}
              />
            ),
